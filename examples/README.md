...
- **Features**: Dynamic table routing based on exchange/symbol, compressed data handling, string column (`stock_id`), timestamp value column (`event_time` via `extract_timestamp`)
